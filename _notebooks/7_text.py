...
# 화면 타이틀 설정
pygame.display.set_caption("Jaesu Game") # 게임 이름
...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/한재수/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/한재수/pygame_basic/enemy.png")
...
# 20 fps : 1초 동안에 20번 동작 -> 1번에 몇 만큼 이동? 5만큼! 20 * 5 = 100
    
    # 아래는 프레임 확인하는 코드인데 정신나갈 것 같아서 주석처리함
    # print("fps : " + str(clock.get_fps())) 
    
    for event in pygame.event.get(): # 어떤 이벤트가 발생했는가?
        if event.type == pygame.QUIT: # 창이 닫히는 이벤트가 발생했는가?
            runnig = False # 게임이 진행중이 아니다
